    ...
    <div className="relative bg-white border border-gray-200 rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl hover:border-primary transition-all duration-200 group">
      ...
      <div className="relative">
        <img 
          src={project.image} 
          alt={project.title}
          className="w-full h-44 sm:h-52 lg:h-60 xl:h-72 object-cover rounded-t-3xl border-b border-gray-100 group-hover:scale-105 transition-transform duration-200"
        />
